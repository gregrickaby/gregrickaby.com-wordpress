...
<?php if ( $has_primary_nav && $has_primary_nav_items ) : ?>
	<nav id="site-navigation" class="primary-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Main', 'seedlet' ); ?>">
		<button id="primary-close-menu" class="button close">
			<span class="dropdown-icon close"><?php esc_html_e( 'Close', 'seedlet' ); ?> <?php echo seedlet_get_icon_svg( 'close' ); ?></span>
...
<div class="menu-button-container">
	<?php if ( $has_primary_nav && $has_primary_nav_items ) : ?>
		<button id="primary-open-menu" class="button open">
			<span class="dropdown-icon open"><?php esc_html_e( 'Menu', 'seedlet' ); ?> <?php echo seedlet_get_icon_svg( 'menu' ); ?></span>
